...
var maxid=0;
	...
	function searchSuggest() {
		...
		xmlhttp.open("POST", "talk?search=",true);
	...
	function processReuqest() {
		...
		if (xmlhttp.readyState == 4) {
			if (xmlhttp.status == 200) {
				...
				userinfoObj.innerHTML = "用户A:&nbsp;&nbsp;&nbsp;"+sendtime;
				//alert(userinfoObj.innerHTML);
				var a = str.substring(21,str.indexOf("☆"));
				if(parseInt(maxid)<parseInt(str.substring(str.indexOf("☆")+1))&&parseInt(maxid)!=0){
					changeTitle();
					usercontentObj.innerHTML=usercontentObj.innerHTML+"<div id='userinfo'>用户A:&nbsp;&nbsp;&nbsp;"+sendtime+"</div><div id='usercontent'><li>"+str.substring(21,str.indexOf("☆"))+"</li></div>";
