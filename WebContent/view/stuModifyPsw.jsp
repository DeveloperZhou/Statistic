...
function submit(){
		if (validCheck()) {
			document.fm.action="./stuModifyPswAction.jsp";
		document.fm.submit();
		return;
	}
}
...
function checkOldPsw(oldpassword)
  ...
  fm.action = "./stuCheckOldPswAction.jsp";
  fm.submit();
  }
...
<br/><br/>
		...
		<tr align="left">
			<td id="td1">
				<input type="button" value="确定更改 " name="stuadd" onclick="submit();" class="btn"/>&nbsp;&nbsp;
				<input type="button" value="取消更改" onclick="back();" class="btn"/>
			 </td>
		</tr>
		</table>
	</body>
