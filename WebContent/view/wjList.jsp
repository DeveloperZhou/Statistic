...
//知识点编辑
function PointEdit_onClick()
{
	 window.self.location="./pointList.jsp";
}
//知识点编辑
function MajorEdit_onClick()
{
	 window.self.location="./majorList.jsp";
}
...
//预览
function preview(id){
	window.open("./adminPreview.jsp?oid="+id);
}
...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td align="center">
    ...
    <input type='button' class="coolbg np" onClick="PointEdit_onClick();" value='知识点编辑' />
    <input type='button' class="coolbg np" onClick="MajorEdit_onClick();" value='班级编辑' />
    ...
    <input type='button' class="coolbg np" onClick="term_onClick();" value='终止提交' />
