...
<%
	...
	int score = StudentService.getOneAllScore(username);
	boolean saveScore = StudentService.updateScore(username, score);
	if(falg && saveScore) System.out.println("提交答案成功！");
%>
<html>
<head>
...
<p style="margin:5px;text-align:left;padding:0 20px;text-indent:2em;line-height:1.6em;font-size:14px;">提交成功。
<br/>
</p>
</div>
